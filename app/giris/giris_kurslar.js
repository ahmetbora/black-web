...
const GirisKurslar = ({ onePage = false, dark = false }) => {

  const teamMembers = [
    {
      name: "Thomas Johnson",
      role: "Developer, co-founder",
      image: "/assets/black/main-kurslar-2-1.jpg",
      socials: [
    ...
    },
    {
      ...
      image: "/assets/black/main-kurslar-2-2.jpg",
      socials: [
        { platform: "Facebook", icon: "fa-facebook-f", url: "#" },
        { platform: "Twitter", icon: "fa-twitter", url: "#" },
        { platform: "Pinterest", icon: "fa-pinterest-p", url: "#" },
    ...
    },
    {
      name: "Marta Laning",
      role: "Web developer",
      image: "/assets/black/main-kurslar-2-3.jpg",
      socials: [
        { platform: "Facebook", icon: "fa-facebook-f", url: "#" },
        { platform: "Twitter", icon: "fa-twitter", url: "#" },
        { platform: "Pinterest", icon: "fa-pinterest-p", url: "#" },
  ...
  return (
    <section
      className={`page-section  scrollSpysection  ${dark ? "bg-dark-2 light-content" : "bg-gray-light-1 "
        }`}
      id="team"
    >
        ...
        <div className="row">
          ...
          <div className="col-md-6 mb-sm-60 mb-xs-40 d-flex align-items-center">
            <blockquote className="testimonial mb-0 wow fadeInUp">
              ...
              <p>
                Hayallerinizi <br />
                Gerçekleştirecek <br />Güçlü bir takımız.
              </p>
              <footer>
                <div className="section-line mb-10" />
                {"Ücretsiz bir DENEME DERS'ine girmeden karar varmeyin."}
              </footer>
            </blockquote>
          </div>
          {/* End Quote */}
                    ...
                    <div className="team-carousel-item">
                      <div className="team-item">
                        <div className="team-item-image">
                          ...
                          />
                          <div className="team-item-detail d-none">
                        ...
                        <div className="team-item-descr d-none">
