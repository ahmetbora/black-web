"use client"
const BlackTamirSectionCalgilar = () => {
  return (
      ...
      <div className="container position-relative">
        <div className="row">
          ...
          <div className="col-lg-5 col-xl-5 offset-xl-1 d-flex align-items-center mb-md-60 mb-sm-40">
            <div className="w-100">
              <h2 className="section-caption mb-30 mb-xs-10">
                Enstrumanınız mı arızalandı ?
              </h2>
              <h3 className="section-title mb-30">
                Doğru Yerdesiniz !
              </h3>
              <p className="section-descr mb-50 mb-sm-30">
                Enstuman tamiri tecrube ve titizlik gerektirir. 10 yıllık tecrubemiz ile,
                enstürümanınızın tamir ve bakımını tamamlayarak mümkün olan en iyi durumda getirmek için çalışıyoruz.
              </p>
              {/* Numbers */}
          ...
          <div className="col-lg-7 col-xl-6 d-flex align-items-center order-lg-first">
            <div className="w-100 position-relative clearlinks">
              <div className="row masonry mb-n30 wow fadeInUp">
                ...
                <div className="col-md-6 mb-30">
                  <div className="alt-features-item box-shadow text-center mt-0">
                    ...
                    <h4 className="alt-features-title">
                      <a href="/entruman-tamir/vurmali-calgilar" >Vurmalı Çalgılar</a>
                    </h4>
                    <div className="alt-features-descr">
                      Vivamus varius, nisi vel dictum tempor, libero
                      nisl iaculis est, ut rutrum elit ante ac velit.
                    </div>
                  </div>
                </div>
                {/* End Benefits Item */}
...
export default BlackTamirSectionCalgilar;